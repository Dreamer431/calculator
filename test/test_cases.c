...
TestCase basicTests[] = {
    ...
    {"3^0.5", 1.7320508075688772, 0, NULL}, // 测试小数幂
    {"2^0", 1, 0, NULL},         // 测试0次幂
};
...
TestCase constantTests[] = {
    ...
    {"log(e)", 0.4342944819032518, 0, NULL},   // 测试e常量与常用对数
};
...
TestCase boundaryTests[] = {
    {"0.000000001", 1e-9, 0, NULL},           // 测试小数
    {"9999999999", 9999999999, 0, NULL},      // 测试大数（使用int64_t后不再溢出）
    {"1/1000000000", 1e-9, 0, NULL},          // 测试小分数
    {"0.1^10", 1e-10, 0, NULL},               // 测试小数幂
    {"sin(89.999999)", 1, 0, NULL},           // 测试接近90度的正弦值
    {"cos(89.999999)", 0, 0, NULL},           // 测试接近90度的余弦值
    {"pi*1e-10", 3.14159265358979e-10, 0, NULL}, // 测试常量与小数相乘
    {"(1+1e-10)^2", 1.0000000002, 0, NULL},   // 测试复杂表达式
    {NULL, 0, 0, NULL}
}; 